...
<%--                                <asp:ListItem Selected="True">Selected</asp:ListItem>--%>
                    ...
                    <tr>
                       ...
                       <tr>
                        <td class="auto-style2" align="center" style="font-family: Miriam; color: #FFFFFF">
                    ...
                    <tr>
                        ...
                        <td class="style2" colspan="2" align="center">
                            <asp:DropDownList ID="DropDownList8" runat="server" OnSelectedIndexChanged="DropDownList8_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="style2" colspan="2" align="center">
                            <asp:DropDownList ID="DropDownList9" runat="server" Style="margin-bottom: 0px" Width="86px" Visible="False">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td class="style1" align="center" style="font-family: Miriam; color: #FFFFFF">
                            <asp:Label ID="Label5" runat="server" Text="BillID："></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                ErrorMessage="*" ControlToValidate="youxiang" ValidationGroup="1"></asp:RequiredFieldValidator>
                        </td>
                    ...
                    <tr>
                        <td class="style1" align="center">
                            <asp:Button ID="Button2" runat="server" Text="Add" OnClick="Button2_Click" 
                                ValidationGroup="1" style="height: 21px" />
                        </td>
                        <td class="style2" colspan=2 align="center">
                    ...
                    <tr>
                        <td colspan="3" class="style3" align="center">
                            <%--<asp:Button ID="Button6" runat="server" Text="Insert Multiple Member Information" 
            ...
            <div style="width: 70%; float: right;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
                    ...
                    EnableModelValidation="True" Visible="False" DataKeyNames="PatientID" OnPageIndexChanging="GridView1_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Price" DataField="BillPrice"/>
                        <asp:HyperLinkField HeaderText="More" Text="Select" DataNavigateUrlFields="PatientID,DoctorID,RecordID,BillID" DataNavigateUrlFormatString="~/IT/Billview.aspx?PatientID={0}&DoctorID={1}&RecordID={2}&BillID={3}"
                            Target="main" />
