                ...
                <table>
                    <tr>
                        ...
                        <td class="style2" align="center">
                            <asp:DropDownList ID="DropDownList1" runat="server" Style="margin-bottom: 0px" 
                                ...
                                DataValueField="DepartmentName" Width="70px">
                    ...
                    <tr>
                        <td class="style1" align="center">
                            <asp:Label ID="Label8" runat="server" Text="Department ID：" Font-Names="Miriam" 
                    ...
                    <tr>
                        <td class="style4" align="center">
                            ...
                            <asp:DropDownList ID="DropDownList5" runat="server" 
                                DataSourceID="SqlDataSource2" DataTextField="DepartmentName" DataValueField="DepartmentName" >
                            </asp:DropDownList>
                        </td>
                        <td class="style4" colspan="2">
                            <center><asp:Button ID="Button7" runat="server" Text="Modify Department" Width="135px" OnClick="Button7_Click" /></center>
                        </td>
                    </tr>
                    <tr>
                        <td class="style4">
                    ...
                    <tr>
                        <td class="style1" align="center">
                            <asp:Label ID="Label6" runat="server" Text="Tel：" Font-Names="Miriam" 
                                ForeColor="White"></asp:Label>
                        </td>
                        <td class="style2" colspan="2">
                            <asp:TextBox ID="dizhi" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style1" align="center">
                            <asp:Label ID="Label7" runat="server" Text="Address：" Font-Names="Miriam" 
                                ForeColor="White"></asp:Label>
                        </td>
                        <td class="style2" colspan="2">
                            <asp:TextBox ID="lianxifangshi" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style1" align="center">
            ...
            <div style="width: 70%; float: right;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Department" DataField="MemberDepartment" />
                        <asp:HyperLinkField HeaderText="More" Text="Select" DataNavigateUrlFields="MemberID"
