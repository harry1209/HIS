                ...
                <table>
                    ...
                    <tr>
                        <td colspan="3" align="center" style="font-family: Miriam; color: #FFFFFF">
                            Add Patient Record Information：
                        </td>
                    </tr>
                    <tr>
                        <td class="style1" align="center" style="font-family: Miriam; color: #FFFFFF">
                        ...
                        <td class="style2" colspan="2" align="center">
                            <asp:DropDownList ID="DropDownList2" runat="server" Style="margin-bottom: 0px" Width="70px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="3" class="style3" align="center">
                            <%--<asp:Button ID="Button6" runat="server" Text="Insert Multiple PatientRecord Information" 
            ...
            <div style="width: 70%; float: right;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="More" Text="Select" DataNavigateUrlFields="DoctorID,PatientID,RecordID" DataNavigateUrlFormatString="~/IT/Recordview.aspx?DoctorID={0}&PatientID={1}&RecordID={2}"
                            Target="main" />
