            ...
            <div style="width: 70%; float: right;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="More" Text="Select" DataNavigateUrlFields="PatientID,DoctorID,RecordID,BillID" DataNavigateUrlFormatString="~/Nurse/Billview.aspx?PatientID={0}&DoctorID={1}&RecordID={2}&BillID={3}"
                            Target="main" />
                    </Columns>
