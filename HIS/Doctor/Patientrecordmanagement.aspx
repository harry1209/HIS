    ...
    <form id="form1" runat="server">
        <center>
            <div>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="style4" colspan="3" align="center"
                                style="font-family: Miriam; color: #FFFFFF">Add Patient
                            </td>

                        </tr>
                        <tr>
                            <td class="style1" align="center" style="font-family: Miriam; color: #FFFFFF">
                                <asp:Label ID="Label8" runat="server" Text="MemberID："></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                    ErrorMessage="*" ControlToValidate="mid" ValidationGroup="2"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            <td class="style1" align="center">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                    ErrorMessage="*" ControlToValidate="xingming" ValidationGroup="2"></asp:RequiredFieldValidator>
                            </td>
                            <td class="style2" colspan="2">
                        ...
                        <tr>
                            <td class="style1" align="center" style="font-family: Miriam; color: #FFFFFF">
                                <asp:Label ID="Label3" runat="server" Text="To DoctorID："></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                    ErrorMessage="*" ControlToValidate="mid" ValidationGroup="2"></asp:RequiredFieldValidator>

                            </td>
                            <td class="style2" colspan="2">
                                <asp:DropDownList ID="authdid" runat="server" DataSourceID="SqlDataSource1" DataTextField="MemberID" DataValueField="MemberID">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Button ID="auth" runat="server" Text="Authorization" OnClick="auth_Click" />
                            </td>
                        ...
                        <tr>
                            <td colspan="3" align="center" style="font-family: Miriam; color: #FFFFFF">Add Patient Record Information：
                            </td>
                        </tr>
                        <tr>
                            <td class="style1" align="center" style="font-family: Miriam; color: #FFFFFF">
                        ...
                        <tr>
                            <td class="style1" align="center" style="font-family: Miriam; color: #FFFFFF">
                                <asp:Label ID="Label5" runat="server" Text="RecordID："></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                    ErrorMessage="*" ControlToValidate="record" ValidationGroup="1"></asp:RequiredFieldValidator>
                            </td>
                            <td class="style2" colspan="2">
                                <asp:TextBox ID="record" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                ...
                <asp:Label ID="Label11" runat="server" Font-Size="X-Large" Visible="False"
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField HeaderText="More" Text="Select" DataNavigateUrlFields="DoctorID,PatientID,RecordID" DataNavigateUrlFormatString="~/Doctor/Recordview.aspx?DoctorID={0}&PatientID={1}&RecordID={2}"
                                Target="main" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:db_HospitalConnectionString %>" SelectCommand="SELECT [MemberID] FROM [Member_Information] WHERE ([MemberDepartment] = @MemberDepartment)">
                    <SelectParameters>
