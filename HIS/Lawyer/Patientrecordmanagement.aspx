            ...
            <div style="width: 70%; float: right;">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="More" Text="Select" DataNavigateUrlFields="DoctorID,PatientID,RecordID" DataNavigateUrlFormatString="~/Lawyer/Recordview.aspx?DoctorID={0}&PatientID={1}&RecordID={2}"
                            Target="main" />
