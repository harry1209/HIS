...
public partial class Management : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.IsPostBack)
        {
            ...
            string sqlallMember = "select * from Bill_Information join Member_Information on Bill_Information.PatientID=Member_Information.MemberID where Bill_Information.PatientID='"+Convert.ToString(Session["IDLogin"])+"'";
            ...
            string sql3 = "select distinct(" + a1 + "ID) from Bill_Information where PatientID='" + Convert.ToString(Session["IDLogin"]) + "'";
            ...
            string sql = "select distinct(PatientID) from Record_Information where PatientID='" + Convert.ToString(Session["IDLogin"]) + "'";
            ...
            //string sql2 = "select RecordID from Record_Information where PatientID='" + a + "' and PatientID='" + Convert.ToString(Session["IDLogin"]) + "'";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (type!="Selected")
        {
            if (type == "Patient")
                type = "Member";
            sqlallMember = "select * from Bill_Information join Member_Information on Bill_Information.PatientID=Member_Information.MemberID and Bill_Information." + type + "ID='" + num + "' and Bill_Information.PatientID='" + Convert.ToString(Session["IDLogin"]) + "'";
            DataSet ds = new DataSet();
        ...
        else
        {
            ...
            sqlallMember = "select * from Bill_Information join Member_Information on Bill_Information.PatientID=Member_Information.MemberID where Bill_Information.PatientID='" + Convert.ToString(Session["IDLogin"]) + "'";
            this.GridView1.Visible = true;
            this.Label10.Visible = true;
            this.Label11.Visible = true;
            this.Label11.Text = "All";
